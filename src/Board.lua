...
function Board:initializeTiles(level)
    ...
    for tileY = 1, 8 do
        ...
        for tileX = 1, 8 do
            ...
            elseif self.level <= 20 or self.level > 5 then
                table.insert(self.tiles[tileY], Tile(tileX, tileY, math.random(7, 12), math.random(3)))
            else
                table.insert(self.tiles[tileY], Tile(tileX, tileY, math.random(10, 18), math.random(6)))
            end
        end
    end
    ...
    for x = 1, 8 do
        for y = 8, 1, -1 do
            ...
            if not tile then
                ...
                if self.level <= 5 then
                    tile = Tile(x, y, math.random(9), 1)
                elseif self.level <= 20 or self.level > 5 then
                    tile = Tile(x, y, math.random(9), math.random(3))
                else
                    tile = Tile(x, y, math.random(9), math.random(6))
                end
                tile.y = -32
                self.tiles[y][x] = tile
